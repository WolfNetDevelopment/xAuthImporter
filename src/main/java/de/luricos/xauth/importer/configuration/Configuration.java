package de.luricos.xauth.importer.configuration;
...
public interface Configuration extends ConfigurationSection {
     ...
     * you should set the default source with {@link #setDefaults(de.luricos.xauth.importer.configuration.Configuration)}.
     *
